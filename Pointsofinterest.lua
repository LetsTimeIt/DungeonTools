...
local function POI_SetOptions(frame, type, poi, homeSublevel)
        ...
        frame:SetScript(
            ...
            function()
                ...
                if connectedDoor then
                    ...
                    GameTooltip:AddLine(
                        "\n" .. string.format(L["%s is in sublevel: %s"], npcName, sublevelName),
                        1,
                        1,
                        1
                    )
    ...
    if type == "graveyard" then
        ...
        frame:SetScript(
            ...
            function()
                GameTooltip:SetOwner(UIParent, "ANCHOR_CURSOR")
                GameTooltip:AddLine(
                    L["Graveyard"] .. (slen(poi.graveyardDescription) > 0 and "\n" .. poi.graveyardDescription or ""),
                    1,
                    1,
                    1,
                    1
    ...
    if type == "mechagonBot" then
        ...
        frame.Texture:SetVertexColor(
            botOptions[poi.botIndex].color.r,
            botOptions[poi.botIndex].color.g,
            botOptions[poi.botIndex].color.b,
            botOptions[poi.botIndex].color.a
        )
