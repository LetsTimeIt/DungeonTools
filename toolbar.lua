...
function MDT:initToolbar(frame)
    ...
    frame.toolbar.toggleButton:SetNormalTexture("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\arrows")
    ...
    back:SetImage("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\icons",0.5,0.75,0.5,0.75)
    ...
    forward:SetImage("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\icons",0.75,1,0.5,0.75)
    ...
    minus:SetImage("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\icons",0,0.25,0.5,0.75)
    ...
    plus:SetImage("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\icons",0.25,0.5,0.5,0.75)
    ...
    pencil:SetImage("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\icons",0,0.25,0,0.25)
    ...
    arrow:SetImage("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\icons",0.25,0.5,0,0.25)
    ...
    note:SetImage("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\icons",0.75,1,0,0.25)
    ...
    mover:SetImage("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\icons",0.5,0.75,0,0.25)
    ...
    cogwheel:SetImage("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\icons",0,0.25,0.25,0.5)
    cogwheel:SetCallback("OnClick",function (widget,callbackName)
        InterfaceOptionsFrame_OpenToCategory("ManbabyDungeonTools")
        InterfaceOptionsFrame_OpenToCategory("ManbabyDungeonTools")
        MDT:HideInterface()
    end)
    ...
    eraser:SetImage("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\icons",0.25,0.5,0.25,0.5)
    ...
    delete:SetImage("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\icons",0.25,0.5,0.75,1)
...
function MDT:CreateBrushPreview(frame)
    frame.brushPreview = CreateFrame("Frame","ManbabyDungeonToolsBrushPreview",UIParent)
    ...
    frame.brushPreview.tex:SetTexture("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\ring")
...
function MDT:UpdateSelectedToolbarTool(widgetName)
    ...
    toolbar.highlight:SetTexture("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\icons")
...
function MDT:StartArrowDrawing()
    ...
    line:SetTexture("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\Square_White")
    line:SetVertexColor(db.toolbar.color.r,db.toolbar.color.g,db.toolbar.color.b,db.toolbar.color.a)
    line:Show()
    local arrow = getTexture()
    arrow:SetTexture("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\triangle")
...
function MDT:DrawCircle(x, y, size, color, layer, layerSublevel, isOwn, objectIndex, tex, noinsert, extrax, extray)
    ...
    circle:SetTexture("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\Circle_White")
...
function MDT:DrawTriangle(x, y, rotation, size, color, layer, layerSublevel, isOwn, objectIndex)
    ...
    if not layer then layer = objectDrawLayer end
    triangle:SetTexture("Interface\\AddOns\\ManbabyDungeonTools\\Textures\\triangle")
