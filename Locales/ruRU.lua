...
L["Click the fullscreen button for a maximized view of MDT."] =
    "Вы можете перевести MDT в полноэкраный режим нажав красную стрелочку в правом верхнем углу"
...
L[
    ...
    "При нажатии этой кнопки будет произведена попытка присоединиться к совместному сеансу вашей группы или таковой будет создан если сеанс не будет найден"
...
L["deleteAllDrawingsPrompt"] =
    "Вы уверены, что хотите удалить ВСЕ нарисованные объекты из текущего маршрута?%sЭто действие невозможно отменить."
L["deleteAllWarning"] =
...
L["Enemies related to seasonal affixes are currently hidden"] =
    "Враги связанные с сезонными модификаторами не отображены"
...
L["Expand the top toolbar to gain access to drawing and note features."] =
    "Расширьте верхнюю строку чтобы получить доступ к функциям рисования и заметок"
...
L["Hold SHIFT to create a new pull while selecting enemies."] =
    "Зажмите SHIFT, чтобы создавать отельные пулы при выборе врагов"
L["Hold SHIFT to delete all presets with the delete preset button."] =
    'Зажмите SHIFT, чтобы удалить все шаблоны при помощи кнопки "удалить шаблон"'
...
L["Mouseover a patrolling enemy with a blue border to view the patrol path."] =
    "Наведите мышкой поверх патрульного с синей рамкой чтобы увидеть его путь"
L["Mouseover the Live button while in a group to learn more about Live mode."] =
    "Наведите мышкой поверх кнопки Совместный сеанс во время нахождения в группе чтобы узнать больше о Совместном сеансе"
...
L["plaguefallDevotedNote"] =
    'Чумные прислужники которые были трансформированны при помощи умения "Сочащийся остов" до входа в бой с НИП Икор Желчная Плоть не засчитываются как силы врага'
...
L["Players can join the live session by either clicking this button or the Live Session chat link"] =
    "Игроки могут присоединиться к совместному сеансу нажав на эту кнопку или на ссылку совместного сеанса в чате"
...
L["Right click an enemy to open the enemy info window."] =
    "Нажмите правой кнопкой мыши на противника чтобы открыть окно информации"
--[[Translation missing --]]
...
L["Start or join the current |cFF00FF00Live Session|r"] =
    "Создайте или присоединитесь к текущему |cFF00FF00Совместному сеансу|r"
...
L["The preset will continuously synchronize between all party members participating in the Live Session"] =
    "Этот шаблон будет постоянно синхронизироваться между всеми членами группы, которые участвуют в Совместном Сеансе"
...
L[
    ...
    'Чтобы поделиться другим шаблоном во время работы совместного сеанса просто откройте нужный шаблон и нажмите на кнопку "Совместный сеанс"'
--[[Translation missing --]]
--[[ L["tocNotes"] = ""--]]
...
L["Use /mdt reset to restore the default position and scale of MDT."] =
    "Используйте команду /mdt, чтобы вернуть расположение и размер окна по умолчанию"
...
L[
    ...
    ] = 'Вы всегда можете вернуться к шаблону Совместного Сеанса нажав на кнопку "Вернуться к Совместному Сеансу" '
L["You can choose from different color palettes in the automatic pull coloring settings menu."] =
    "Вы можете выбрать из различных цветовых палеток в меню автоматического окрашивания"
L["You can cycle through different floors by holding CTRL and using the mousewheel."] =
    "Вы можете переключаться между этажами при помощи CTRL+колесо мыши"
L["You can cycle through dungeons by holding ALT and using the mousewheel."] =
    "Вы можете переключаться между подземельями зажав ALT+Колесо мышки"
L["You can find MDT exports from other users on the wago.io website"] =
    "Вы можете найти маршруты для MDT, созданные другими пользователями на сайте wago.io"
