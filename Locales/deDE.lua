...
L["atalTeemingNote"] =
    "Wimmelnd Notiz:%s%sG29 ist nicht immer anwesend. %swimmelnde Gegner von G2 sind nicht immer anwesend.%sG27 ist nicht immer anwesend"
...
L["Click the fullscreen button for a maximized view of MDT."] =
    "Klicke auf den Vollbild Button für eine Vollbild Ansicht von MDT."
...
L[
    ...
    "Klicke auf diesen Button um zu versuchen einer laufenden Live Sitzung deiner Gruppe beizutreten oder eine neue zu starten falls keine gefunden wurde"
...
L["ConnectedTip"] =
    "Gruppenverbindungen in MDT spiegeln nicht wider, ob NPCs in der Spielwelt miteinander verbunden sind."
...
L["deleteAllDrawingsPrompt"] =
    "Möchtest du ALLE Zeichnungen der aktuellen Route löschen?%sDies kann nicht rückgängig gemacht werden%s%s"
L["deleteAllWarning"] =
    "!!ACHTUNG!!%sMöchtest du wirklich ALLE Routen dieser Instanz löschen?%sEs werden %s Route(n) gelöscht%sDies kann nicht rückgängig gemacht werden"
...
L["Earlier Version"] =
    "Du hast eine frühere Version dieser Route mit dem Namen '%s'%sMöchtest du sie aktualisieren oder eine neue Kopie erstellen?%s%s%s"
...
L["Enemies related to seasonal affixes are currently hidden"] =
    "Gegner die zum saisonalen Affix gehören sind aktuell versteckt"
...
L["Expand the top toolbar to gain access to drawing and note features."] =
    "Öffne die obere Symbolleiste um Zugriff auf Zeichnen- und Notizfunktionen zu erhalten."
...
L["helpPlateNPC"] =
    "Klicken um Gegner auszuwählen%sSTRG-Klick um einzelne Gegner auszuwählen%sUMSCHALT-Klick um Gegner auszuwählen und einen neuen Pull zu erstellen"
...
L["Hold SHIFT to create a new pull while selecting enemies."] =
    "Halte UMSCHALT gedrückt um einen neuen Pull zu erstellen während Gegner ausgewählt werden"
L["Hold SHIFT to delete all presets with the delete preset button."] =
    "Halte UMSCHALT um alle Routen mit dem Route-löschen Button zu löschen"
...
L["LargePresetWarning"] =
    "Du versuchst eine sehr große Route zu teilen (%d Zeichen)%sEs wird stattdessen empfohlen die Export-Funktion zu verwenden um große Routen auf wago.io zu teilen.%sBist du dir sicher diese Route zu teilen?%s"
L["Legion"] = "Legion"
L["Level %d %s"] = "Stufe %d %s"
L["Levels below 10 will hide enemies related to seasonal affixes"] =
    "Unter Stufe 10 werden betroffene Gegner vom saisonalen Affix versteckt"
...
L["mlJockeyNote"] =
    "Mechjockey 21 und 22 müssen in genau dem Moment Schaden erhalten wo ihre Friedensbewahrer zerstört werden um zu den Streitkräften zu zählen"
...
L["Please report any bugs on https://github.com/Tomslack/ManbabyDungeonTools/issues"] =
    "Bitte alle Fehler auf https://github.com/Tomslack/ManbabyDungeonTools/issues melden"
...
L["receiveErrorUpdate"] =
    "MDT konnte eine Route nicht ordnungsgemäß erhalte. Stelle bitte sicher, dass Sender %s die neueste Version von MDT installiert hat!"
L["Receiving: ..."] = "Erhalte: ..."
...
L["Right click an enemy to open the enemy info window."] =
    "Einen Gegner rechtsklicken um das Gegner info Fenster zu öffnen."
...
L["tdWardenFightingNote"] =
    "G23 kämft untereinander und Blockwärter 1 wird nach einer gewissen Zeit von den anderen NPCs besiegt werden."
L["Teeming"] = "Wimmelnd"
...
L["templeEyeNote"] =
    "Auge von Sethraliss%sBringt beide Augen zu dem Schädel von Sethraliss%sEin Auge welches ihr zu dem Schädel bringt zählt für 12 Streitkräfte"
...
L["The selected affixes are not the ones of the current week"] =
    "Die ausgewählten Affixe sind nicht die der aktuellen Woche"
...
L["underrotVoidNote"] =
    "Spawns von Leerenberührte Abgesandte 2 und 3 sind zufällig.%sNur eine von ihnen wird vorzufinden sein."
L["Undo"] = "Rückgängig"
...
L["Use /mdt reset to restore the default position and scale of MDT."] =
    "Verwende '/mdt reset' um die Standardposition und -skalierung von MDT wiederherzustellen."
...
L["wcmWorldquestNote"] =
    "Notiz zu G52:%sG52 wird nicht anwesend sein solange die Weltquest für das Besiegen von Matrone Christiane aktiv ist."
...
L["You can choose from different color palettes in the automatic pull coloring settings menu."] =
    "Du kannst von verschiedenen Paletten im automatischen Färbungs Menü wählen."
...
L["You can find MDT exports from other users on the wago.io website"] =
    "Du kannst auf der wago.io Website MDT Routen von anderen Benutzern finden"
