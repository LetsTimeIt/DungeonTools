...
L["Click the fullscreen button for a maximized view of MDT."] =
    "Clicca il pulsante della modalità schermo intero per visualizzare MDT a tutto schermo."
...
L["deleteAllDrawingsPrompt"] =
    "Desideri cancellare TUTTI i disegni di questo percorso?%sQuesta azione non può essere annullata%s%s"
L["deleteAllWarning"] =
    "!!ATTENZIONE!! Desideri cancellare TUTTI i percorsi di questa spedizione? Stai per cancellare %s percorso/i%s. Questa azione non può essere annullata."
...
L["Earlier Version"] =
    "Stai utilizzando una versione precedente di questo percorso con il nome '%s'%sDesideri aggiornarlo o crearne una nuova copia?%s%s%s"
...
L["Enemies related to seasonal affixes are currently hidden"] =
    "I nemici relativi agli affissi stagionali sono attualmente nascosti"
...
L["Expand the top toolbar to gain access to drawing and note features."] =
    "Espandi la barra degli strumenti superiore per accedere alle funzioni di disegno e annotazione."
...
L["frackingNote"] =
    "Totem d'Estrazione%sUtilizzabile dai giocatori%sInabilita uno Spaccaterra per 1min - I danni ne annullano l'effetto"
...
L["freeholdBeguilingPatrolNote"] =
    "Settimana 2/5/8/11: il gruppo G53 è stazionario alla posizione dell'Emissaria delle Maree 13"
...
L["helpPlateNPC"] =
    "Fai clic per selezionare i nemici Fai CTRL-Clic per selezionare i nemici singolarmente Fai SHIFT-Clic per selezionare i nemici e creare un nuovo pull"
...
L["Hold SHIFT to create a new pull while selecting enemies."] =
    "Tieni premuto SHIFT per creare un nuovo pull mentre selezioni i nemici."
L["Hold SHIFT to delete all presets with the delete preset button."] =
    'Tieni premuto SHIFT per cancellare tutti i percorsi con il pulsante "Cancella percorso".'
...
L["LargePresetWarning"] =
    "Stai cercando di condividere un percorso molto grande (%d caratteri)%sPer i percorsi di grandi dimensioni, si raccomanda di utilizzare la funzione esporta e di condividerli sul sito wago.io.%sConfermi di voler condividere questo percorso?%s"
--[[Translation missing --]]
--[[ L["Legion"] = ""--]]
L["Level %d %s"] = "%s di livello %d"
L["Levels below 10 will hide enemies related to seasonal affixes"] =
    "Selezionando livelli inferiori a 10, i nemici relativi agli affissi stagionali saranno nascosti"
...
L["mlJockeyNote"] =
    "I Manovratori di Mech 21 e 22 devono essere colpiti nel momento in cui i Pacificatori vengono distrutti"
...
L["Please report any bugs on https://github.com/Tomslack/ManbabyDungeonTools/issues"] =
    "Ti preghiamo di segnalare eventuali bug all'indirizzo: https://github.com/Tomslack/ManbabyDungeonTools/issues"
...
L["receiveErrorUpdate"] =
    "MDT non ha ricevuto correttamente il percorso. Assicurati che il mittente %s stia utilizzando l'ultima versione di MDT!"
...
L["Right click an enemy to open the enemy info window."] =
    "Fai clic destro su un nemico per aprirne la finestra delle informazioni."
...
L["Shift-Click to delete all presets for this dungeon"] =
    "Fai SHIFT-Clic per cancellare tutti i percorsi di questa spedizione"
...
L["tdWardenFightingNote"] =
    "Il gruppo G23 è impegnato in combattimento e finirà con l'uccidere il Custode del Braccio 1"
L["Teeming"] = "Sciame"
...
L["The selected affixes are not the ones of the current week"] =
    "Gli affissi selezionati non sono quelli di questa settimana"
...
L["The selected level will affect displayed npc health"] =
    "Il livello selezionato influirà sulla salute visualizzata dei PNG"
...
L["underrotVoidNote"] =
    "Le posizioni dell'Emissaria Toccata dal Vuoto 2 e 3 sono casuali.%sSarà presente una sola di esse in un dato momento."
L["Undo"] = "Annulla"
...
L["Use /mdt reset to restore the default position and scale of MDT."] =
    "Usa il comando /mdt reset per reimpostare la posizione e le dimensioni di default di MDT."
...
L["wcmWorldquestNote"] =
    "Nota sul gruppo G52: il gruppo%sG52 non sarà presente quando la missione mondiale che ha come obiettivo la sconfitta di Matron Christiane è attiva"
...
L["You can find MDT exports from other users on the wago.io website"] =
    "Sul sito wago.io puoi trovare percorsi di MDT esportati da altri utenti"
L["You can share MDT exports on the wago.io website"] =
    "Puoi esportare i tuoi percorsi di MDT e condividerli sul sito wago.io"
