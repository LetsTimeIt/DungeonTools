...
L["atalTeemingNote"] =
    "Note sur Grouillant : %s%sG29 n'est pas toujours présent.%sLes ennemis grouillant du G2 ne sont pas toujours présents.%sG27 n'est pas toujours présent"
...
L["Click the fullscreen button for a maximized view of MDT."] =
    "Cliquez sur le bouton plein-écran pour un vue maximisée de MDT "
...
L[
    ...
    "En cliquant sur ce bouton, vous tenterez de rejoindre la session Live en cours de votre groupe ou d'en créer une nouvelle si aucune n'est trouvée "
...
L["deleteAllWarning"] =
    "!!Attention!!%sSouhaitez vous réellement supprimer TOUTES vos routes pour ce donjon ?%sVous êtes sur le point de supprimer %s route(s)%sCela ne peut pas être annuler"
...
L["Earlier Version"] =
    "Vous disposez d'une version antérieure de cette route avec le nom '%s'%sVoulez-vous mettre à jour ou créer une nouvelle copie ?%s%s%s"
...
L["Enemies related to seasonal affixes are currently hidden"] =
    "Les ennemies liés aux affixes saisonnier sont actuellement cachés "
...
L["Expand the top toolbar to gain access to drawing and note features."] =
    "Développez la barre d'outils supérieure pour accéder aux fonctions de dessin et de note. "
...
L["frackingNote"] =
    "Totem de fracturation%Utilisable par les joueurs%sStupéfie un Enrageterre pour 1min - L’effet se dissipe lorsque la cible subit des dégâts. "
...
L["helpPlateNPC"] =
    "Cliquez pour sélectionner les ennemis%sCTRL-Click pour choisir des ennemies un à un%sSHIFT-Click pour sélectionner les ennemies et créer un nouveau pull "
...
L["Hold SHIFT to create a new pull while selecting enemies."] =
    "Maintenez la touche SHIFT tout en sélectionnant les ennemis pour créer un nouveau pull. "
L["Hold SHIFT to delete all presets with the delete preset button."] =
    "Maintenez la touche SHIFT enfoncée pour supprimer toutes les routes à l'aide de la touche de suppression des routes. "
...
L["LargePresetWarning"] =
    "Vous essayez de partager une route très grande (%d caractères)%sIl est recommandé d'utiliser la fonction d'export et de partager de grandes routes via wago.io à la place.%sÊtes-vous sûr de vouloir partager cette préconfiguration ?%s "
L["Legion"] = "Légion"
L["Level %d %s"] = "Niveau %d %s "
L["Levels below 10 will hide enemies related to seasonal affixes"] =
    "Les niveaux inférieurs à 10 cacheront les ennemis liés aux affixes saisonniers "
...
L["Players can join the live session by either clicking this button or the Live Session chat link"] =
    "Les joueurs peuvent rejoindre la session en direct en cliquant sur ce bouton ou sur le lien du chat de la session en direct  "
L["Please report any bugs on https://github.com/Tomslack/ManbabyDungeonTools/issues"] =
    "Veuillez signaler tout bugs sur https://github.com/Tomslack/ManbabyDungeonTools/issues"
...
L["receiveErrorUpdate"] =
    "MDT n'a pas pu recevoir correctement la route, veuillez vous assurer que la personne vous l'envoyant %s a installé la dernière version de MDT ! "
...
L["Right click an enemy to open the enemy info window."] =
    "Cliquez avec le bouton droit sur un ennemi pour ouvrir la fenêtre d'informations sur l'ennemi. "
...
L["Start or join the current |cFF00FF00Live Session|r"] =
    "Démarrer ou rejoindre la session en cours |cFF00FF00Live Session|r "
...
L["templeEyeNote"] =
    "Œil de Sephraliss%sAmenez les deux yeux au crane de Sephraliss%sChaque œil que vous apporterez au crane vous donnera 12 points de forces ennemies "
...
L["The preset will continuously synchronize between all party members participating in the Live Session"] =
    "La route se synchronisera en permanence entre tous les membres du groupe participant à la session en direct "
...
L["The selected affixes are not the ones of the current week"] =
    "Les affixes sélectionnés ne sont pas ceux de la semaine en cours "
...
L[
    ...
    'Pour partager une route différente pendant que la session en direct est active, il suffit de naviguer vers la route préférée et de cliquer sur le nouveau bouton "Passer en direct" à côté du menu déroulant des routes '
...
L["underrotVoidNote"] =
    "Les spawns des Émissaires touchés par le vide 2 et 3 sont aléatoires.%sSeul un des deux sera présent à un temps donné.  "
L["Undo"] = "Annuler "
...
L["Use /mdt reset to restore the default position and scale of MDT."] =
    "Utilisez '/mdt reset' pour rétablir la position et l'échelle par défaut de MDT. "
...
L["wcmWorldquestNote"] =
    "Note sur le G52:%sG52 ne sera pas présent tant que la Worldquest pour vaincre la Matrone Christiane sera active "
...
L[
    ...
    'Vous pouvez toujours revenir à la préconfiguration de la session live en cours en cliquant sur le bouton "Retour au direct" à côté de la liste déroulante des routes'
L["You can choose from different color palettes in the automatic pull coloring settings menu."] =
    "Vous pouvez choisir parmi différentes palettes de couleurs dans le menu des paramètres de coloriage automatique. "
L["You can cycle through different floors by holding CTRL and using the mousewheel."] =
    "Vous pouvez parcourir les différents étages en maintenant la touche CTRL enfoncée et en utilisant la molette de la souris."
...
L["You can find MDT exports from other users on the wago.io website"] =
    "Vous pouvez trouver des exports MDT d'autres joueurs sur le site web wago.io "
