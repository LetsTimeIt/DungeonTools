...
L["atalTeemingNote"] =
    "Nota en Bullente:%s&sG29 no siempre presente.%sEnemigos Bullentes de G2 no siempre presentes.%sG27 no siempre presente"
...
L["Click the fullscreen button for a maximized view of MDT."] =
    "Haz click en el botón de pantalla completa para maximizar la vista de MDT."
...
L["ConnectedTip"] =
    "Las conexiones de grupo en MDT no reflejan si los NPC están vinculados entre sí en el mundo del juego."
...
L["deleteAllWarning"] =
    "¡¡AVISO!!%sQuieres eliminar TODOS los preajustes de esta mazmorra?%sEstás a punto de eliminar %s ruta(s)%sÉsto no se puede deshacer"
...
L["Earlier Version"] =
    "Tienes una version anterior con el nombre de la ruta '%s'%s¿Quieres actualizarlo o crear una nueva copia?%s%s%s"
...
L["Enemies related to seasonal affixes are currently hidden"] =
    "Los enemigos relacionados a afijos de temporada están actualmente ocultos"
...
L["Expand the top toolbar to gain access to drawing and note features."] =
    "Expande la barra de herramientas superior para ganar acceso a características de dibujo y notas."
...
L["frackingNote"] =
    "Tótem de hidrofracturación%sUsable por jugadores%sIncapazita Terracundo por 1min - El daño lo rompe"
...
L["helpPlateNPC"] =
    "Click para seleccionar enemigos%sCTRL-Click para seleccionar un único enemigo%sSHIFT-Click para seleccionar enemigos y crear un nuevo grupo de enemigos"
...
L["Hold SHIFT to create a new pull while selecting enemies."] =
    "Mantén SHIFT para crear un nuevo pull mientras seleccionas enemigos."
L["Hold SHIFT to delete all presets with the delete preset button."] =
    "Mantén SHIFT para eliminar todos las rutas con el botón de eliminar rutas."
...
L["LargePresetWarning"] =
    "Estás intentando compartir una ruta muy grande (%d caracteres)%sSe recomienda usar la función de exportación y compartir rutas grandes a través de wago.io.%s¿Estás seguro de que deseas compartir esta ruta?%s"
L["Legion"] = "Legion"
L["Level %d %s"] = "Nivel %d %s"
L["Levels below 10 will hide enemies related to seasonal affixes"] =
    "Niveles inferiores a 10 ocultarán enemigos relacionados a afijos de temporada"
...
L["mlJockeyNote"] =
    "Jinete de mecas 21 y 22 tienen que ser marcar en el momento en que sus Pacificadores son destruidos"
...
L["Mouseover a patrolling enemy with a blue border to view the patrol path."] =
    "Pase el ratón sobre un enemigo que patrulla con un borde azul para ver el camino de patrulla."
...
L["plaguefallDevotedNote"] =
    "Los devotos de Bajapeste que ya han sido transformados por Carcasa Rezumante antes de enfrentarse a Ickor Carnebilis no otorgan Fuerzas enemigas."
...
L["Please report any bugs on https://github.com/Tomslack/ManbabyDungeonTools/issues"] =
    "Por favor, informe de cualquier error en https://github.com/Tomslack/ManbabyDungeonTools/issues"
...
L["receiveErrorUpdate"] =
    "MDT no pudó recibir una ruta, ¡por favor asegurate que el remitente %s tiene la  ultima versión de MDT instalada!"
...
L["Right click an enemy to open the enemy info window."] =
    "Click derecho en un enemigo para abrir la ventana de información del enemigo."
...
L["siegeGutterNote2"] =
    "G72 Los Destripadores pueden usarse para Fuerzas Enemigas marcandoles con daño y desencadenando la muerte instantánea de los lacayos junto a ellos"
L["siegeGuttersNote"] =
...
L["templeEyeNote"] =
    "Ojo de Sethraliss%sLleva los dos Ojos a la Calavera de Sethraliss%sCada Ojo que lleves a la Calavera da 12 fuerzas enemigas"
...
L["The selected affixes are not the ones of the current week"] =
    "Los afijos seleccionados no son los de la semana actual"
...
L["underrotVoidNote"] =
    "Apariciones de Emisario Tocado del vacio 2 y 3 son aleatorios.%s Solo uno de ellos sera presente a la vez."
L["Undo"] = "Deshacer"
...
L["Use /mdt reset to restore the default position and scale of MDT."] =
    "Haga '/mdt reset' para restaurar la posición y escala predeterminadas de MDT."
...
L["wcmWorldquestNote"] =
    "Nota en G52:%sG52 no estará presente mientras la misión del mundo Matriarca Christiane esta activa"
...
L["You can cycle through dungeons by holding ALT and using the mousewheel."] =
    "Puedes alternar las mazmorras manteniendo ALT y usando la rueda del ratón."
L["You can find MDT exports from other users on the wago.io website"] =
    "Puedes encontrar exportaciones de perfiles de MDT de otros usuarios en el sitio web wago.io"
L["You can share MDT exports on the wago.io website"] =
    "Puedes compartir las exportaciones de MDT en el sitio web wago.io"
