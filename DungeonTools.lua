...
local bottomTips = {
    ...
    [6] = L["Drag the bottom right edge to resize DungeonTools."],
    [7] = L["Click the fullscreen button for a maximized view of DungeonTools."],
    [8] = L["Use /mdt reset to restore the default position and scale of DungeonTools."],
    [9] = L["Mouseover the Live button while in a group to learn more about Live mode."],
    [10] = L["You are using DungeonTools. You rock!"],
