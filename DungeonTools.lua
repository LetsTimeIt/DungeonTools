...
function MDT:GetNumDungeons()
    return #dungeonList - 1
end
function MDT:GetDungeonName(idx)
    return dungeonList[idx]
end
...
function MDT:ToggleDataCollection()
    ...
    print(
        string.format(
            "%sMDT|r: DataCollection %s. Reload Interface!",
            mythicColor,
            db.dataCollectionActive and "|cFF00FF00Enabled|r" or "|cFFFF0000Disabled|r"
        )
    )
end
...
function MDT:CreateMenu()
    ...
    self.main_frame.closeButton:SetScript(
        "OnClick",
        function()
            self:HideInterface()
        end
    ...
    --Maximize Button
    self.main_frame.maximizeButton =
        CreateFrame("Button", "MDTMaximizeButton", self.main_frame, "MaximizeMinimizeButtonFrameTemplate")
    ...
    self.main_frame.liveReturnButton =
        CreateFrame("Button", "MDTLiveReturnButton", self.main_frame, "UIPanelCloseButton")
    ...
    self.main_frame.setLivePresetButton =
        CreateFrame("Button", "MDTSetLivePresetButton", self.main_frame, "UIPanelCloseButton")
...
function MDT:IsFrameOffScreen()
    ...
    local left = topPanel:GetLeft()
    -->width
    local right = topPanel:GetRight()
    --<0
    local bottom = topPanel:GetBottom()
    --<0
    local top = bottomPanel:GetTop()
    -->height
...
function MDT:MakeSidePanel(frame)
    ...
    dropdown:SetCallback(
        ...
        function(widget, callbackName, key)
            if db.presets[db.currentDungeonIdx][key].value == 0 then
                ...
                MDT:UpdateMap()
                frame.sidePanel.affixDropdown:SetAffixWeek(
                    MDT:GetCurrentPreset().week or MDT:GetCurrentAffixWeek() or 1
                )
            end
        end
    )
    ...
    frame.sidePanelNewButton:SetCallback(
        "OnClick",
        function(widget, callbackName, value)
            MDT:OpenNewPresetDialog()
        end
    )
    frame.sidePanelNewButton.frame:SetScript(
        "OnEnter",
        function()
            GameTooltip:SetOwner(
                frame.sidePanelNewButton.frame,
                "ANCHOR_BOTTOMLEFT",
                frame.sidePanelNewButton.frame:GetWidth() * (-0),
                frame.sidePanelNewButton.frame:GetHeight()
            )
    ...
    frame.sidePanelRenameButton:SetCallback(
        "OnClick",
        function(widget, callbackName, value)
            MDT:HideAllDialogs()
    ...
    frame.sidePanelRenameButton.frame:SetScript(
        "OnEnter",
        function()
            GameTooltip:SetOwner(
                frame.sidePanelRenameButton.frame,
                "ANCHOR_BOTTOMLEFT",
                frame.sidePanelRenameButton.frame:GetWidth() * (-1),
                frame.sidePanelRenameButton.frame:GetHeight()
            )
    ...
    frame.sidePanelImportButton:SetCallback(
        "OnClick",
        function(widget, callbackName, value)
            MDT:OpenImportPresetDialog()
        end
    )
    frame.sidePanelImportButton.frame:SetScript(
        "OnEnter",
        function()
            GameTooltip:SetOwner(
                frame.sidePanelImportButton.frame,
                "ANCHOR_BOTTOMLEFT",
                frame.sidePanelImportButton.frame:GetWidth() * (-1),
                frame.sidePanelImportButton.frame:GetHeight()
            )
    ...
    frame.sidePanelExportButton:SetCallback(
        "OnClick",
        function(widget, callbackName, value)
    ...
    frame.sidePanelExportButton.frame:SetScript(
        "OnEnter",
        function()
            GameTooltip:SetOwner(
                frame.sidePanelExportButton.frame,
                "ANCHOR_BOTTOMLEFT",
                frame.sidePanelExportButton.frame:GetWidth() * (-2),
                frame.sidePanelExportButton.frame:GetHeight()
            )
    ...
    frame.sidePanelDeleteButton.frame:SetScript(
        "OnEnter",
        function()
            GameTooltip:SetOwner(
                frame.sidePanelDeleteButton.frame,
                "ANCHOR_BOTTOMLEFT",
                frame.sidePanelDeleteButton.frame:GetWidth() * (-2),
                frame.sidePanelDeleteButton.frame:GetHeight()
            )
    ...
    frame.sidePanelDeleteButton:SetCallback(
        "OnClick",
        function(widget, callbackName, value)
    ...
    frame.LinkToChatButton:SetCallback(
        "OnClick",
        function(widget, callbackName, value)
    ...
    frame.LinkToChatButton.frame:SetScript(
        "OnEnter",
        function()
            GameTooltip:SetOwner(
                frame.sidePanelDeleteButton.frame,
                "ANCHOR_BOTTOMLEFT",
                frame.LinkToChatButton.frame:GetWidth() * (-2),
                -frame.LinkToChatButton.frame:GetHeight()
            )
    ...
    frame.ClearPresetButton:SetCallback(
        "OnClick",
        function(widget, callbackName, value)
            MDT:OpenClearPresetDialog()
        end
    )
    frame.ClearPresetButton.frame:SetScript(
        "OnEnter",
        function()
            GameTooltip:SetOwner(
                frame.ClearPresetButton.frame,
                "ANCHOR_BOTTOMLEFT",
                frame.ClearPresetButton.frame:GetWidth() * (-0),
                frame.ClearPresetButton.frame:GetHeight()
            )
    ...
    frame.LiveSessionButton:SetCallback(
        "OnClick",
        function(widget, callbackName, value)
            if MDT.liveSessionActive then
    ...
    frame.LiveSessionButton.frame:SetScript(
        "OnEnter",
        function()
            GameTooltip:SetOwner(
                frame.LiveSessionButton.frame,
                "ANCHOR_BOTTOMLEFT",
                frame.LiveSessionButton.frame:GetWidth() * (-1),
                frame.LiveSessionButton.frame:GetHeight()
            )
    ...
    frame.MDIButton:SetCallback(
        "OnClick",
        function(widget, callbackName, value)
            MDT:ToggleMDIMode()
        end
    )
    frame.MDIButton.frame:SetScript(
        "OnEnter",
        function()
            GameTooltip:SetOwner(
                frame.MDIButton.frame,
                "ANCHOR_BOTTOMLEFT",
                frame.MDIButton.frame:GetWidth() * (-2),
    ...
    frame.AutomaticColorsCheckSidePanel:SetCallback(
        "OnValueChanged",
        function(widget, callbackName, value)
            ...
            if value == true then
                ...
                MDT:ColorAllPulls()
                MDT.main_frame.AutomaticColorsCogwheel:SetImage(
                    "Interface\\AddOns\\DungeonTools\\Textures\\helpIconRnbw"
                )
            else
                frame.toggleForceColorBlindMode:SetDisabled(true)
                MDT.main_frame.AutomaticColorsCogwheel:SetImage(
                    "Interface\\AddOns\\DungeonTools\\Textures\\helpIconGrey"
                )
            end
        end
    )
    ...
    local timer
    frame.sidePanel.DifficultySlider:SetCallback(
        "OnValueChanged",
        function(widget, callbackName, value)
...
function MDT:ToggleMDIMode()
    ...
    if self.liveSessionActive then
        self:LiveSession_SendMDI("toggle", db.MDI.enabled and "1" or "0")
    end
end
...
function MDT:DisplayMDISelector()
    ...
    if not MDT.MDISelector then
        ...
        local freeholdList = {
            string.format("1. %s", L["Cutwater"]),
            string.format("2. %s", L["Blacktooth"]),
...
function MDT:FormatEnemyForces(forces, forcesmax, progressbar)
    if not forcesmax then
        forcesmax =
            MDT:IsCurrentPresetTeeming() and MDT.dungeonTotalCount[db.currentDungeonIdx].teeming or
...
function MDT:UpdateProgressbar()
    ...
    MDT:Progressbar_SetValue(
        MDT.main_frame.sidePanel.ProgressBar,
        grandTotal,
...
function MDT:ZoomMapToDefault()
    ...
    if
        (currentMapInfo and currentMapInfo.viewportPositionOverrides and
            currentMapInfo.viewportPositionOverrides[currentSublevel])
     then
...
function MDT:UpdatePullTooltip(tooltip)
    ...
    elseif MouseIsOver(frame.sidePanel.newPullButton.frame) then
        ...
        if
            frame.sidePanel.newPullButtons and tooltip.currentPull and
                frame.sidePanel.newPullButtons[tooltip.currentPull]
         then
            --enemy portraits
            local showData
            for _, v in pairs(frame.sidePanel.newPullButtons[tooltip.currentPull].enemyPortraits) do
                if MouseIsOver(v) then
                    if v:IsShown() then
                        --model
                        if
                            v.enemyData.displayId and
                                (not tooltip.modelNpcId or (tooltip.modelNpcId ~= v.enemyData.displayId))
                         then
                        ...
                        local newLine = "\n"
                        local text =
                            newLine .. newLine .. newLine .. v.enemyData.name .. " x" .. v.enemyData.quantity .. newLine
                        text =
                            text ..
                            string.format(L["Level %d %s"], v.enemyData.level, v.enemyData.creatureType) .. newLine
                        local boss = v.enemyData.isBoss or false
                        local health =
                            MDT:CalculateEnemyHealth(
                            boss,
                        ...
                        for _, v in pairs(clones) do
                            if MDT:IsCloneIncluded(enemyIdx, v) then
                                local count =
                                    ...
                                    self.dungeonEnemies[db.currentDungeonIdx][enemyIdx].count
...
function MDT:IsCloneIncluded(enemyIdx, cloneIdx)
    local preset = MDT:GetCurrentPreset()
    local isCloneBlacktoothEvent =
        MDT.dungeonEnemies[db.currentDungeonIdx][enemyIdx]["clones"][cloneIdx].blacktoothEvent
    ...
    if db.currentSeason ~= 3 then
        if emissaryIds[MDT.dungeonEnemies[db.currentDungeonIdx][enemyIdx].id] then
            return false
        end
    elseif db.currentSeason ~= 4 then
        if MDT.dungeonEnemies[db.currentDungeonIdx][enemyIdx].corrupted then
            return false
        end
    end
    ...
    if not isCloneBlacktoothEvent or isBlacktoothWeek then
        if not (cloneFaction and cloneFaction ~= preset.faction) then
            ...
            local isCloneNegativeTeeming =
                MDT.dungeonEnemies[db.currentDungeonIdx][enemyIdx]["clones"][cloneIdx].negativeTeeming
...
function MDT:GetEffectivePresetSeason(preset)
    ...
    if db.MDI.enabled then
        ...
        season =
            (mdiWeek == 1 or mdiWeek == 2 or mdiWeek == 3) and 3 or mdiWeek == 13 and 2 or
...
function MDT:IsWeekTeeming(week)
    if not week then
        week = MDT:GetCurrentAffixWeek() or 1
    end
...
function MDT:MakeMapTexture(frame)
    ...
    if frame.scrollFrame == nil then
        ...
        local ignoredTargets = {
            --ignore alt scroll if expansion would be changed
            [14] = true,
            [27] = true,
            [28] = true,
            [37] = true
        }
        frame.scrollFrame:SetScript(
            "OnMouseWheel",
            function(self, delta)
        ...
        for i = 1, 12 do
            ...
            frame["mapPanelTile" .. i]:SetSize(
                frame:GetWidth() / 4 + (5 * db.scale),
                frame:GetWidth() / 4 + (5 * db.scale)
            )
        end
        ...
        for i = 1, 10 do
            for j = 1, 15 do
                frame["largeMapPanelTile" .. i .. j] =
                    frame.mapPanelFrame:CreateTexture("MDTLargeMapPanelTile" .. i .. j, "BACKGROUND")
...
function MDT:CalculateEnemyHealth(boss, baseHealth, level, ignoreFortified)
    ...
    local mult = 1
    if boss == false and fortified == true and (not ignoreFortified) then
        mult = 1.2
    end
...
function MDT:UpdateDungeonDropDown()
    ...
    group.SublevelDropdown:SetValue(
        db.presets[db.currentDungeonIdx][db.currentPreset[db.currentDungeonIdx]].value.currentSublevel
    )
...
function MDT:CreateDungeonSelectDropdown(frame)
    ...
    group.DungeonDropdown:SetCallback(
        "OnValueChanged",
        function(widget, callbackName, key)
            if key == 14 then
    ...
    group.SublevelDropdown:SetCallback(
        "OnValueChanged",
        function(widget, callbackName, key)
...
function MDT:EnsureDBTables()
    ...
    db.presets[db.currentDungeonIdx][db.currentPreset[db.currentDungeonIdx]].value.currentSublevel =
        db.presets[db.currentDungeonIdx][db.currentPreset[db.currentDungeonIdx]].value.currentSublevel or 1
    db.presets[db.currentDungeonIdx][db.currentPreset[db.currentDungeonIdx]].value.currentPull =
        db.presets[db.currentDungeonIdx][db.currentPreset[db.currentDungeonIdx]].value.currentPull or 1
    db.presets[db.currentDungeonIdx][db.currentPreset[db.currentDungeonIdx]].value.pulls =
        db.presets[db.currentDungeonIdx][db.currentPreset[db.currentDungeonIdx]].value.pulls or {}
    ...
    if
        not db.presets[db.currentDungeonIdx][db.currentPreset[db.currentDungeonIdx]].value.pulls[
            db.presets[db.currentDungeonIdx][db.currentPreset[db.currentDungeonIdx]].value.currentPull
        ]
     then
        db.presets[db.currentDungeonIdx][db.currentPreset[db.currentDungeonIdx]].value.currentPull =
...
function MDT:UpdateMap(ignoreSetSelection, ignoreReloadPullButtons, ignoreUpdateProgressBar)
    ...
    if
        (db.currentPreset[db.currentDungeonIdx] == 1 or db.currentPreset[db.currentDungeonIdx] == presetCount) or
            MDT.liveSessionActive
     then
        MDT.main_frame.sidePanelDeleteButton:SetDisabled(true)
        MDT.main_frame.sidePanelDeleteButton.text:SetTextColor(0.5, 0.5, 0.5)
    else
...
function MDT:UpdateToDungeon(dungeonIdx, sublevel, ignoreUpdateMap, init)
    ...
    if dungeonIdx >= 29 then
        db.currentExpansion = 3
    end

    if
        dungeonIdx and
            ((not lastUpdatedDungeonIdx or dungeonIdx ~= lastUpdatedDungeonIdx) or (db.currentDungeonIdx ~= dungeonIdx))
     then
    ...
    if
        not db.presets[db.currentDungeonIdx][db.currentPreset[db.currentDungeonIdx]].value.currentSublevel or
            db.presets[db.currentDungeonIdx][db.currentPreset[db.currentDungeonIdx]].value.currentSublevel ~=
                (sublevel or 1)
     then
...
MDT.zoneIdToDungeonIdx = {
    ...
    [1664] = {
        -- halls of atonement - nave of pain
        ["dungeon"] = 30,
        ["subzone"] = 2
    },
    [1665] = {
        -- halls of atonement - sanctuary of souls
        ["dungeon"] = 30,
        ["subzone"] = 3
    },
    [1666] = {
    ...
    [1667] = {
        -- necrotic wake - stitchwerks
        ["dungeon"] = 35,
        ["subzone"] = 2
    },
    [1668] = {
        -- necrotic wake - zolramus
        ["dungeon"] = 35,
        ["subzone"] = 3
    },
    ...
    [1697] = {
        -- plaguefall festering sanctum
        ["dungeon"] = 32,
        ["subzone"] = 2
    },
    [1675] = {
        -- sanguine depths depths of despair
        ["dungeon"] = 33,
        ["subzone"] = 1
    },
    [1676] = {
        -- sanguine depths - amphitheater of sorrow
        ["dungeon"] = 33,
        ["subzone"] = 2
    },
    [1677] = {
    ...
    [1678] = {
        -- de other side mechagon
        ["dungeon"] = 29,
        ["subzone"] = 2
    },
    [1679] = {
        -- de other side zul'gurub
        ["dungeon"] = 29,
        ["subzone"] = 3
    },
    [1680] = {
        -- de other side - main platform
        ["dungeon"] = 29,
        ["subzone"] = 1
    },
    [1683] = {
    ...
    [1684] = {
        -- theater of pain chambers of conquest
        ["dungeon"] = 36,
        ["subzone"] = 2
    },
    [1685] = {
        -- theater of pain altars of agony
        ["dungeon"] = 36,
        ["subzone"] = 3
    },
    [1686] = {
        -- theater of pain upper barrow of carnage
        ["dungeon"] = 36,
        ["subzone"] = 4
    },
    [1687] = {
        -- theater of pain lower barrow of carnage
        ["dungeon"] = 36,
        ["subzone"] = 5
    },
    [1692] = {
        -- spires of ascension honors ascent
        ["dungeon"] = 34,
        ["subzone"] = 1
    },
    [1693] = {
    ...
    [1695] = {
        -- spires of ascension seat of the archon
        ["dungeon"] = 34,
        ["subzone"] = 4
    }
}
    ...
    if duplicate == false then
        ...
        if startingPointPresetIdx > 0 then
            db.presets[db.currentDungeonIdx][countPresets] =
                MDT:CopyObject(db.presets[db.currentDungeonIdx][startingPointPresetIdx])
...
function MDT:MakePresetImportFrame(frame)
    ...
    frame.presetImportFrame:SetCallback(
        "OnClose",
        function(widget)
            MDT:UpdatePresetDropDown()
            if db.currentPreset[db.currentDungeonIdx] ~= 1 then
    ...
    frame.presetImportBox:SetCallback(
        "OnEnterPressed",
...
function MDT:MakePresetCreationFrame(frame)
    ...
    frame.presetCreationFrame:SetCallback(
        "OnClose",
        function(widget)
            MDT:UpdatePresetDropDown()
            if db.currentPreset[db.currentDungeonIdx] ~= 1 then
    ...
    frame.PresetCreationEditbox:SetCallback(
        "OnEnterPressed",
        function(widget, event, text)
            --check if name is valid, block button if so, unblock if valid
    ...
    frame.presetCreationCreateButton:SetCallback(
        "OnClick",
        function()
...
function MDT:ImportPreset(preset, fromLiveSession)
    ...
    local updateCallback = function()
        if self.main_frame.ConfirmationFrame then
            self.main_frame.ConfirmationFrame:SetCallback(
                "OnClose",
                function()
                end
            )
...
local colorPaletteValues = {
    ...
    [5] = {
        --Color Blind Friendly values (Based on IBM's color library "Color blind safe"
    ...
    if (pullIdx) then
        ...
        if colorPaletteInfo.autoColoring or bypass == true then
            ...
            if db.colorPaletteInfo.forceColorBlindMode == true and not exportColorBlind then
                ...
                --Regular coloring
                colorValues =
                    colorValues or colorPaletteValues[colorValues] or
                ...
                numberColors =
                    colorPaletteInfo.colorPaletteIdx == 6 and colorPaletteInfo.numberCustomColors or #colorValues -- tables must start from 1 and have no blank rows
            end
...
function MDT:ColorAllPulls(colorValues, startFrom, bypass, exportColorBlind)
    local preset = self:GetCurrentPreset()
    local startFromVal = startFrom or 0
    for pullIdx, _ in pairs(preset.value.pulls) do
        if pullIdx >= startFromVal then
...
function MDT:MakeCustomColorFrame(frame)
    ...
    frame.CustomColorFrame.ColorSlider:SetCallback(
        "OnMouseUp",
        function(event, callbackName, value)
            if value > 20 then
...
function MDT:MakeAutomaticColorsFrame(frame)
    ...
    frame.AutomaticColorsCheck:SetValue(db.colorPaletteInfo.autoColoring)
    frame.AutomaticColorsCheck:SetCallback(
        "OnValueChanged",
        function(widget, callbackName, value)
            db.colorPaletteInfo.autoColoring = value
            MDT:SetPresetColorPaletteInfo()
    ...
    frame.toggleForceColorBlindMode:SetCallback(
        "OnValueChanged",
        function(widget, callbackName, value)
    ...
    frame.PaletteSelectDropdown:SetCallback(
        "OnValueChanged",
        function(widget, callbackName, value)
            if value == 6 then
...
function MDT:UpdatePullButtonNPCData(idx)
                    ...
                    for _, cloneIdx in pairs(clones) do
                        ...
                        if MDT.dungeonEnemies[db.currentDungeonIdx][enemyIdx]["clones"][cloneIdx] then
                            if self:IsCloneIncluded(enemyIdx, cloneIdx) then
                                ...
                                enemyTable[enemyTableIdx].count =
                                    MDT.dungeonEnemies[db.currentDungeonIdx][enemyIdx]["count"]
                                enemyTable[enemyTableIdx].teemingCount =
                                    MDT.dungeonEnemies[db.currentDungeonIdx][enemyIdx]["teemingCount"]
                                enemyTable[enemyTableIdx].displayId =
                                    MDT.dungeonEnemies[db.currentDungeonIdx][enemyIdx]["displayId"]
                                ...
                                enemyTable[enemyTableIdx].ignoreFortified =
                                    MDT.dungeonEnemies[db.currentDungeonIdx][enemyIdx]["ignoreFortified"]
                            end
                        end
                    end
                end
    ...
    if
        (math.floor(currentPercent / 0.2) > math.floor(oldPercent / 0.2)) and oldPercent < 1 and db.MDI.enabled and
            preset.mdi.beguiling == 13
     then
...
function MDT:GetFirstNotSelectedPullButton(start, direction)
    ...
    local pullIdx = start
    while MDT.U.contains(MDT:GetCurrentPreset().value.selection, pullIdx) and
        MDT.U.isInRange(pullIdx, 1, #MDT:GetCurrentPreset().value.pulls) do
...
function MDT:MakeRenameFrame(frame)
    ...
    frame.RenameFrame.RenameButton:SetCallback(
        "OnClick",
        function()
...
function MDT:MakeExportFrame(frame)
    ...
    frame.ExportFrameEditbox:SetCallback(
        "OnEnterPressed",
        function(widget, event, text)
        end
    )
...
function MDT:MakeDeleteConfirmationFrame(frame)
    ...
    frame.DeleteConfirmationFrame:SetCallback(
        "OnClose",
        function(widget)
        end
    )
    ...
    frame.DeleteConfirmationFrame.OkayButton:SetCallback(
        "OnClick",
        function()
    ...
    frame.DeleteConfirmationFrame.CancelButton:SetCallback(
        "OnClick",
        function()
            frame.DeleteConfirmationFrame:Hide()
        end
...
function MDT:MakeClearConfirmationFrame(frame)
    ...
    frame.ClearConfirmationFrame:SetCallback(
        "OnClose",
        function(widget)
        end
    )
    ...
    frame.ClearConfirmationFrame.OkayButton:SetCallback(
        "OnClick",
        function()
    ...
    frame.ClearConfirmationFrame.CancelButton:SetCallback(
        "OnClick",
        function()
            frame.ClearConfirmationFrame:Hide()
        end
...
function MDT:CreateTutorialButton(parent)
    ...
    local helpPlate = {
        ...
        [1] = {
            ButtonPos = {x = 205, y = 0},
            HighLightBox = {x = 0, y = 0, width = 200, height = 56},
            ToolTipDir = "RIGHT",
            ToolTipText = L["helpPlateDungeonSelect"]
        },
        [2] = {
            ButtonPos = {x = 205, y = -210 * scale},
            HighLightBox = {x = 0, y = -58, width = (sizex - 6) * scale, height = (sizey * scale) - 58},
            ToolTipDir = "RIGHT",
            ToolTipText = string.format(L["helpPlateNPC"], "\n", "\n")
        },
        [3] = {
            ButtonPos = {x = 900 * scale, y = 0 * scale},
            HighLightBox = {x = 838 * scale, y = 30, width = 251, height = 115},
            ToolTipDir = "LEFT",
            ToolTipText = L["helpPlatePresets"]
        },
        [4] = {
            ButtonPos = {x = 900 * scale, y = -87 * scale},
            HighLightBox = {x = 838 * scale, y = 30 - 115, width = 251, height = 102},
            ToolTipDir = "LEFT",
            ToolTipText = L["helpPlateDungeon"]
        },
        [5] = {
            ButtonPos = {x = 900 * scale, y = -(115 + 102 * scale)},
    ...
    MDT.blizzardOptionsMenuTable = {
        ...
        args = {
            ...
            enemyForcesFormat = {
                ...
                get = function()
                    return db.enemyForcesFormat
                end,
                set = function(_, newValue)
                    db.enemyForcesFormat = newValue
                end,
                style = "dropdown"
            },
            enemyStyle = {
                ...
                get = function()
                    return db.enemyStyle
                end,
                set = function(_, newValue)
                    db.enemyStyle = newValue
                end,
                style = "dropdown"
            }
        }
...
function initFrames()
    ...
    local skinTooltip = function(tooltip)
        if IsAddOnLoaded("ElvUI") and ElvUI[1].Tooltip then
            ...
            if tooltip.String then
                tooltip.String:SetFont(tooltip.String:GetFont(), 11)
            end
            if tooltip.topString then
                tooltip.topString:SetFont(tooltip.topString:GetFont(), 11)
            end
            if tooltip.botString then
                tooltip.botString:SetFont(tooltip.botString:GetFont(), 11)
            end
        end
    end
    --tooltip new
    ...
    do
        ...
        if true then
            MDT.pullTooltip.Model:SetScript(
                "OnUpdate",
                function(self, elapsed)
                    self.fac = self.fac + 0.5
                    if self.fac >= 360 then
