...
local function MakeEnemeyInfoFrame()
    ...
    local function DrawGroup1(container)
        ...
        f.enemyDataContainer.nameEditBox:SetCallback(
            "OnTextChanged",
            function(self)
        ...
        f.enemyDataContainer.idEditBox:SetCallback(
            "OnTextChanged",
            function(self)
                self:SetText(self.defaultText)
            end
        ...
        f.enemyDataContainer.healthEditBox:SetLabel(" ")
        --has to be non empty for proper spacing, we set this later
        f.enemyDataContainer.healthEditBox:DisableButton(true)
        f.enemyDataContainer.healthEditBox:SetCallback(
            "OnTextChanged",
            function(self)
                self:SetText(self.defaultText)
            end
        ...
        f.enemyDataContainer.creatureTypeEditBox:SetCallback(
            "OnTextChanged",
            function(self)
                self:SetText(self.defaultText)
            end
        ...
        f.enemyDataContainer.levelEditBox:SetCallback(
            "OnTextChanged",
            function(self)
                self:SetText(self.defaultText)
            end
        ...
        f.enemyDataContainer.countEditBox:SetCallback(
            "OnTextChanged",
            function(self)
                self:SetText(self.defaultText)
            end
        ...
        f.enemyDataContainer.teemingCountEditBox:SetCallback(
            "OnTextChanged",
            function(self)
                self:SetText(self.defaultText)
            end
        ...
        f.enemyDataContainer.stealthCheckBox:SetCallback(
            "OnValueChanged",
            function(self)
        ...
        f.enemyDataContainer.stealthDetectCheckBox:SetCallback(
            "OnValueChanged",
            function(self)
                self:SetValue(self.defaultValue)
            end
